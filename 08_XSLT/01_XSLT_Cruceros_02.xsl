...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">	
		...
		<body>
			...
			<!-- 
			Busqueda absoluta de "detalle" de un crucero. Por defecto, si lo ponemos 
			...
			OJO, si usaramos un motor de XPath como en 07_XPATH, veríamos 
			...
			<!-- 
			Busqueda de "detalle" de un crucero, no empieza por "/" por lo que las 
			busquedas son relativas al nodo que nos encontramos, en este caso en el nodo raíz que 
			...
			<!--
			Los nodos "crucero" que tengan una duracion de 7 días
			-->
